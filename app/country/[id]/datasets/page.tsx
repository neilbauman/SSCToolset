...
async function loadDatasets(){
 const{data,error}=await supabase.from("view_country_datasets")
   .select("*").eq("country_iso",params.id).order("title");
...
<tr><th className="px-3 py-2 text-left">Title</th><th>Year</th><th>Admin</th>
<th>Type</th><th>Format</th><th>Indicator</th><th>Taxonomy Category</th>
<th>Taxonomy Term</th><th className="w-28">Actions</th></tr></thead>
<tbody>
...
(<table className="min-w-full"><thead><tr><th className="text-left px-2 py-1 border-b">Admin PCode</th>
...
<tbody>{preview.map((r,i)=><tr key={i}>
