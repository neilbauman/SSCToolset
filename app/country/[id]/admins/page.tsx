...
export default function AdminsPage({ params }: { params: CountryParams }) {
  ...
  const [admToggles, setAdmToggles] = useState({
    1: true,
    2: false,
    3: false,
    4: false,
              ...
              <div className="grid grid-cols-2 gap-2">
                <label className="block">
                  ...
                  <input
                    type="text"
                    value={
                      editingVersion.source
                        ? JSON.parse(editingVersion.source).name || ""
                        : ""
                    }
                    onChange={(e) =>
                      setEditingVersion({
                        ...
                        source: JSON.stringify({
                          ...(editingVersion.source
                            ? JSON.parse(editingVersion.source)
                            : {}),
                          name: e.target.value,
                        }),
                      })
                ...
                <label className="block">
                  ...
                  <input
                    ...
                    value={
                      editingVersion.source
                        ? JSON.parse(editingVersion.source).url || ""
                        : ""
                    }
                    onChange={(e) =>
                      setEditingVersion({
